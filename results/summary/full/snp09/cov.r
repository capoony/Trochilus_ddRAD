...
df <- read.table('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09_cov.txt',header=T,na.string='na')
...
for (j in c(0.5,0.75,1.0)){
  ...
  for (i in levels(as.factor(df$Sample))){
    ...
    #   facet_grid(Poly~m)
    #
    # ggsave(paste0('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09/cov/cov_',i,'_',j,'.png'),width=12,height=6)
    ...
    ggsave(paste0('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09/cov/cov_line_',i,'_',j,'.png'),width=12,height=6)
  }
}
...
ggsave('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09/cov/cov_diff.png',width=12,height=18)
...
ggsave('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09/cov/cov_av.png',width=8,height=4)
