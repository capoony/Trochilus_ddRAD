...
df <- read.table('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09_stats.txt',header=T,na.string='na')
df1<-df %>%
  #select(Name,i) %>%
...
#
# ggsave(paste0('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09/summary_',i,'.png'),width=12,height=6)
...
ggsave(paste0('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09/stat/summary_line_',i,'.png'),width=12,height=6)
...
#   facet_grid(PropCovLoci~m)
#
# ggsave('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09/summary_CummNoLoci.png',width=12,height=6)
...
ggsave('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp09/stat/summary_line_CummNoLoci.png',width=12,height=6)
