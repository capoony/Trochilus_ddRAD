...
df <- read.table('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp095_stats.txt',header=T,na.string='na')
df1<-df %>%
  #select(Name,i) %>%
...
#
# ggsave(paste0('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp095/summary_',i,'.png'),width=12,height=6)
...
ggsave(paste0('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp095/stat/summary_line_',i,'.png'),width=12,height=6)
...
#   facet_grid(PropCovLoci~m)
#
# ggsave('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp095/summary_CummNoLoci.png',width=12,height=6)
...
ggsave('/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/full/snp095/stat/summary_line_CummNoLoci.png',width=12,height=6)
