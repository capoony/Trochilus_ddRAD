...
mkdir /media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/ohne/cov
...
df <- read.table("/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/ohne/summary_cov.txt",header=T)
...
for (j in c(0.5,0.75,1.0)){
  ...
  for (i in levels(as.factor(df$Sample))){
    ...
    #   facet_grid(Poly~m)
    #
    # ggsave(paste0("/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/ohne/cov/cov_",i,"_",j,".png"),width=12,height=6)
    ...
    ggsave(paste0("/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/ohne/cov/cov_line_",i,"_",j,".png"),width=12,height=6)
  }
}
...
#
# ggsave("/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/ohne/cov/cov_diff.png",width=12,height=18)
#
# df2.cov<-df %>%
#   group_by(Sample)%>%
...
#   xlab("Sample Name")
#
# ggsave("/media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/ohne/cov/cov_av.png",width=8,height=4)

''' > /media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/ohne/summary_cov.r

Rscript /media/inter/mkapun/projects/Trochilus_ddRAD/results/summary/ohne/summary_cov.r
